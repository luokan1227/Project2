...
This sub-data set contains 6661 observations and 51 variables.  
...
```
    ...
    ##  1st Qu.:0.6287           1st Qu.:  4.00   1st Qu.: 1.000  
    ##  Median :0.6939           Median :  7.00   Median : 3.000  
    ##  Mean   :0.6728           Mean   : 10.62   Mean   : 3.367  
    ##  3rd Qu.:0.7544           3rd Qu.: 13.00   3rd Qu.: 4.000  
    ##  Max.   :1.0000           Max.   :162.00   Max.   :51.000  
    ##     num_imgs        num_videos     average_token_length  num_keywords   
    ##  Min.   : 0.000   Min.   : 0.000   Min.   :0.000        Min.   : 1.000  
    ##  1st Qu.: 1.000   1st Qu.: 0.000   1st Qu.:4.475        1st Qu.: 6.000  
    ##  Median : 1.000   Median : 0.000   Median :4.656        Median : 7.000  
    ##  Mean   : 4.382   Mean   : 1.367   Mean   :4.536        Mean   : 7.153  
    ##  3rd Qu.: 3.000   3rd Qu.: 1.000   3rd Qu.:4.840        3rd Qu.: 9.000  
    ##  Max.   :93.000   Max.   :74.000   Max.   :6.513        Max.   :10.000  
    ##  data_channel_is_lifestyle data_channel_is_entertainment
    ##  Min.   :0.00000           Min.   :0.0000               
    ##  1st Qu.:0.00000           1st Qu.:0.0000               
    ##  Median :0.00000           Median :0.0000               
    ##  Mean   :0.04719           Mean   :0.2059               
    ...
    ##  1st Qu.:0.0000        1st Qu.: -1.00   1st Qu.:   441   1st Qu.:  136.2  
    ##  Median :0.0000        Median : -1.00   Median :   651   Median :  230.5  
    ##  Mean   :0.2072        Mean   : 26.82   Mean   :  1231   Mean   :  317.1  
    ##  3rd Qu.:0.0000        3rd Qu.:  4.00   3rd Qu.:  1000   3rd Qu.:  352.6  
    ##  Max.   :1.0000        Max.   :318.00   Max.   :298400   Max.   :29946.9  
    ##    kw_min_max       kw_max_max       kw_avg_max       kw_min_avg    
    ##  Min.   :     0   Min.   :     0   Min.   :     0   Min.   :  -1.0  
    ##  1st Qu.:     0   1st Qu.:843300   1st Qu.:173315   1st Qu.:   0.0  
    ##  Median :  1400   Median :843300   Median :242336   Median : 994.2  
    ##  Mean   : 11822   Mean   :748229   Mean   :257156   Mean   :1086.4  
    ##  3rd Qu.:  7200   3rd Qu.:843300   3rd Qu.:330765   3rd Qu.:1986.1  
    ##  Max.   :690400   Max.   :843300   Max.   :798220   Max.   :3602.1  
    ##    kw_max_avg       kw_avg_avg    self_reference_min_shares
    ##  Min.   :     0   Min.   :    0   Min.   :     0           
    ##  1st Qu.:  3531   1st Qu.: 2355   1st Qu.:   659           
    ##  Median :  4255   Median : 2832   Median :  1200           
    ##  Mean   :  5582   Mean   : 3074   Mean   :  3951           
    ##  3rd Qu.:  5938   3rd Qu.: 3535   3rd Qu.:  2600           
    ##  Max.   :298400   Max.   :33536   Max.   :690400           
    ##  self_reference_max_shares self_reference_avg_sharess     LDA_00       
    ##  Min.   :     0            Min.   :     0             Min.   :0.01818  
    ##  1st Qu.:  1100            1st Qu.:  1000             1st Qu.:0.02517  
    ##  Median :  2800            Median :  2168             Median :0.03341  
    ##  Mean   :  9970            Mean   :  6321             Mean   :0.18670  
    ##  3rd Qu.:  7900            3rd Qu.:  5200             3rd Qu.:0.24603  
    ##  Max.   :843300            Max.   :690400             Max.   :0.91999  
    ...
    ##  Mean   :0.15456   Mean   :0.21064   Mean   :0.21781   Mean   :0.23029  
    ##  3rd Qu.:0.17145   3rd Qu.:0.32402   3rd Qu.:0.35340   3rd Qu.:0.39356  
    ##  Max.   :0.91997   Max.   :0.92000   Max.   :0.91998   Max.   :0.92708  
    ##  global_subjectivity global_sentiment_polarity global_rate_positive_words
    ##  Min.   :0.0000      Min.   :-0.38021          Min.   :0.00000           
    ##  1st Qu.:0.3951      1st Qu.: 0.05543          1st Qu.:0.02820           
    ##  Median :0.4512      Median : 0.11732          Median :0.03817           
    ##  Mean   :0.4402      Mean   : 0.11631          Mean   :0.03900           
    ##  3rd Qu.:0.5047      3rd Qu.: 0.17457          3rd Qu.:0.04975           
    ##  Max.   :1.0000      Max.   : 0.55455          Max.   :0.12139           
...
![](mondayAnalysis_files/figure-gfm/shares-1.png)<!-- -->
...
![](mondayAnalysis_files/figure-gfm/logshare-1.png)<!-- -->
...
![](mondayAnalysis_files/figure-gfm/corr-1.png)<!-- -->
...
![](mondayAnalysis_files/figure-gfm/channel_sub-1.png)<!-- -->
...
![](mondayAnalysis_files/figure-gfm/channel_sub-2.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 3109, 3107, 3108 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  RMSE       Rsquared   MAE      
    ##    2    0.8972513  0.1429696  0.6695292
    ##   14    0.8970970  0.1376143  0.6666099
    ##   26    0.8994541  0.1339101  0.6696040
    ##   38    0.9004259  0.1322992  0.6702057
    ##   50    0.9037594  0.1267860  0.6712881
    ## 
...
![](mondayAnalysis_files/figure-gfm/RF-1.png)<!-- -->
...
![](mondayAnalysis_files/figure-gfm/RF-2.png)<!-- -->
...
```
    ...
    ## 1 Adj R Square     0.125     0.079     0.096
    ## 2          AIC 12335.340 12533.448 12449.376
    ## 3         AICc 12336.490 12533.505 12449.479
    ## 4          BIC 12664.147 12604.367 12546.084
...
```
    ...
    ##                    lin_miss
    ## rf_miss             0.400200100050025
    ##   0.379189594797399                 1

The lower missaccuracy rate is 0.3791896. Random Forests and linear
