...
Using random Forests method to do the non-linear fit, as this method has best performance in the reference paper.  
...
In genweal, lin_fit1 has higher Adj R Square values, will choose lin_fit1 to do the prediction.  
